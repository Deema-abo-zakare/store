  ...
  <head><script src="../assets/js/color-modes.js"></script>
    ...
    <style>
      ...
      .bi {
        ...
        font-size: 1rem; /* يمكنك تغيير الحجم حسب الحاجة */
        width: 16px; /* ضبط العرض */
         height: 16px; /* ضبط الارتفاع */
    ...
    <!-- Custom styles for this template -->
    <link href="{{asset('assets/dist/css/dashboard/dashboard.rtl.css')}}" rel="stylesheet">
  </head>
  <body>
    ...
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                ...
                <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-black" href="#">اسم الشركة</a>
      ...
      <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        ...
        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
          <ul class="nav flex-column">
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2 active" aria-current="page" href="{{ url('products/create') }}">
